...
import url from 'url'
import { Word } from './wordApiRepository'
import { WordsApiRequest, IApiRequestConfig } from './wordApiRequest'
import { IWord } from '../wordService/wordApiRepository'

// TAKEN FROM https://rapidapi.com/dpventures/api/wordsapi/
// THIS CLASS BUILDS THE URL AFTER THE BASE URL
export class axiosWordRequestUrlBuilder {
